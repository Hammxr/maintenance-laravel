...
<head>
    ...
    <title>Request Submitted - Republic Lifestyle CMMS</title>
    ...
    <footer class="bg-gray-900 text-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="flex items-center justify-center mb-4">
                ...
                <span class="ml-2 text-lg font-bold">Republic Lifestyle</span>
            </div>
            <p class="text-gray-400">&copy; {{ date('Y') }} Republic Lifestyle CMMS. All rights reserved.</p>
        </div>
    </footer>
</body>
</html>